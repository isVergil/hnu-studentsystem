    ...
    <div class="layuimini-main">
        <form class="layui-form" action="">
            ...
            <div class="layui-form-item">
                <label class="layui-form-label">上级字典名称：</label>
                <div class="layui-input-block">
                    <input type="text" value="${parentname}" lay-verify="title" autocomplete="off" class="layui-input"
                           readonly>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">添加的字典名称：</label>
                <div class="layui-input-block">
                    <input type="text" name="name" lay-verify="required" lay-reqtext="字典是必填项！" placeholder="必填"
